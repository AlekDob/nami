# NamiOS — Manual Test & Documentation Guide
...
NamiOS is an always-on AI personal assistant running on a Hetzner server. It uses an
...
- [ ] Header shows "Nami -- AI Personal Assistant"
...
```
> crea un file chiamato test-note.txt in data con scritto "Nami is alive!"
...
Start NamiOS, then: `ls -la /root/meow/data/jobs/`
