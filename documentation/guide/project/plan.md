# PLAN.md — NamiOS Implementation Plan

> Full briefing for any agent implementing NamiOS.
> Read AGENTS.md first for project context, then this file for the plan.

## What We're Building

NamiOS (formerly Meow) is an **always-on AI personal assistant** that:
...
NamiOS is self-hosted: each user installs their own instance on their server.
