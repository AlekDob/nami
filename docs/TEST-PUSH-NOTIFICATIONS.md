...
1. **Documentation**: Explains how push notifications work in MeowApp
...
| Event | Title | Body |
|-------|-------|------|
| Chat response (via WebSocket) | `Meow` | First 200 chars of response |
...
**What to check**: When someone sends a message to Meow and the app is in the background, a push notification appears.
...
- [ ] The notification title is "Meow"
...
- JWT may have expired unexpectedly. Restart the meow service to force token regeneration
